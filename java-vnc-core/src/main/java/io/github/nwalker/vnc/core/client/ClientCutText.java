...
/**
 * ClientCutText client-to-server message (Section 7.5.6 of RFC 6143).
 *
 * <p>Tells the server that the client has new ISO 8859-1 (Latin-1) text in its cut buffer.
 * Line endings are represented by newline ({@code 0x0a}) alone; no carriage return is used.</p>
 *
 * <p>Wire format: message-type (U8=6) + 3 padding bytes + U32 length + length bytes of text.</p>
 */
public final class ClientCutText {
    ...
    private ClientCutText(Builder b) {
        this.text = b.text;
    }
    ...
    /**
     * Reads a ClientCutText from {@code in}.
     * The message-type byte must already have been consumed by the caller.
     */
    public static ClientCutText parse(InputStream in) throws IOException {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ClientCutText)) return false;
        return Objects.equals(text, ((ClientCutText) o).text);
    }
    ...
    public static final class Builder {
        ...
        public ClientCutText build() { return new ClientCutText(this); }
    }
}
